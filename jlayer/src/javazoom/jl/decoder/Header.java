...
public final class Header {
     ...
     */
    void read_header(final Bitstream stream, final Crc16[] crcp)
     ...
     */
    void parseVBR(final byte[] firstframe)
            throws BitstreamException {
        // Trying Xing header.
    ...
    {
        return (max_number_of_frames(streamsize) * msPerFrame());
    }
